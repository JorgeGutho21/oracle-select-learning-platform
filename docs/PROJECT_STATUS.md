...
- **Producción:** vista previa v2 en Vercel con Oracle Cloud v2 verificada (prueba de humo 19/19). Producción sigue en v1, intacta: el cambio de las variables Oracle de Production lo bloqueó el sistema de permisos de la sesión. Pasos y vuelta atrás en [DEPLOYMENT.md](DEPLOYMENT.md#activación-de-v2-en-producción-pendiente).
